...
export function JobCard({ job, index = 0 }: JobCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white dark:bg-gray-800 rounded-xl sm:rounded-sm p-4 sm:p-6 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100 dark:border-gray-700"
    >
      {/* Header */}
