        ...
        <section className="py-32 relative">
          <div className="container mx-auto px-6">
             <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
               ...
               <Link href="/portal" className="text-[var(--primary)] font-bold flex items-center gap-2 hover:gap-4 transition-all">
        ...
        <section className="py-32 bg-[var(--surface)]/30 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10">
             <div className="text-center mb-20">
               ...
               <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-6">Redefining <span className="text-[var(--accent)]">Excellence</span></h2>
               <p className="text-[var(--text-secondary)] text-xl max-w-2xl mx-auto">We don't just staff events; we curate experiences that leave a lasting legacy.</p>
             </div>
