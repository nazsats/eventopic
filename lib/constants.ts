...
export const JOB_CATEGORIES = [
  ...
  { id: "models_entertainment", label: "Models & Entertainment", blurb: "Models, Performers, Dancers, Singers, Artists" },
  { id: "promotions", label: "Promotions & Brand", blurb: "Promoters, Brand Ambassadors, Sales/Sampling Staff" },
  { id: "hospitality", label: "Hospitality", blurb: "Waitstaff, Bartenders, Baristas, Catering" },
